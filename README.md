...
- [Content Migration POC](docs/audio-projects-migration-poc.md) — Migrates pages, building blocks, animations, creative coding, and audio projects from WordPress, rewrites featured image URLs to the Cloudflare R2 bucket, and upserts the results into the production D1 database via Wrangler.
